...
# Conoculars_MODEL_PERFORMER_NAME = "google/gemma-2-2b-it"
# Conoculars_MODEL_OBSERVER_NAME = "google/gemma-2-2b"

Conoculars_MODEL_PERFORMER_NAME = "HuggingFaceTB/SmolLM-360M-Instruct"
Conoculars_MODEL_OBSERVER_NAME = "HuggingFaceTB/SmolLM-360M"


QUANTIZATION_CONFIG = QuantoConfig(weights="int4")

# Conoculars_ACCURACY_THRESHOLD = 0.9015310749276843 
# Conoculars_FPR_THRESHOLD = 0.8536432310785527 
...
class Conoculars:
    ...
    def predict(self, reference_text, device, threshold_possibly=20, threshold_probably=25, threshold_definitely=34) -> Tuple[str, float]:
...
if __name__ == "__main__":
    ...
    Conoculars = Conoculars(Conoculars_MODEL_OBSERVER_NAME, Conoculars_MODEL_PERFORMER_NAME, hugging_face_auth_token)
    
    with open("Conoculars_test_prompt.txt") as file:
        SENTENCE = "\n".join(file.readlines())
    ...
    is_ai_generated, score = Conoculars.predict(SENTENCE, "cuda:0")
